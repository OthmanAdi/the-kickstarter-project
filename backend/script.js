...
/*
Function should go inside the html document, and scan the input-field for text, and if there's text,
then the text will be converted into a TextNode: which is a basically a 2D Text Layer and assign it as
child of <ul></ul>
*/
function addTodo() {
